...
You can learn a bunch at the [Dotfiles Github Site](https://dotfiles.github.io/)
...
5. Do one last Software Audit by editing [Brewfile](Brewfile) directly. (!!this is important!!)
6. [`./install`](install)
7. Restart computer.
